...
This document provides instructions for setting up the Audic Music project for development.
...
Audic Music supports AI-powered lyrics translation. You can configure this in **Settings -> AI Settings**.

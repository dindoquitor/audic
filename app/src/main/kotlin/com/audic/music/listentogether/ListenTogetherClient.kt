...
package com.audic.music.listentogether
...
import com.audic.music.constants.ListenTogetherAutoApprovalKey
import com.audic.music.constants.ListenTogetherIsHostKey
import com.audic.music.constants.ListenTogetherRoomCodeKey
import com.audic.music.constants.ListenTogetherServerUrlKey
import com.audic.music.constants.ListenTogetherSessionTimestampKey
import com.audic.music.constants.ListenTogetherSessionTokenKey
import com.audic.music.constants.ListenTogetherUserIdKey
...
class ListenTogetherClient @Inject constructor(
    ...
    companion object {
        ...
        const val ACTION_APPROVE_JOIN = "com.audic.music.LISTEN_TOGETHER_APPROVE_JOIN"
        const val ACTION_REJECT_JOIN = "com.audic.music.LISTEN_TOGETHER_REJECT_JOIN"
        const val ACTION_APPROVE_SUGGESTION = "com.audic.music.LISTEN_TOGETHER_APPROVE_SUGGESTION"
        const val ACTION_REJECT_SUGGESTION = "com.audic.music.LISTEN_TOGETHER_REJECT_SUGGESTION"
    ...
    private fun loadBlockedUsernames() {
        try {
            val blockedJson = context.dataStore.get(com.audic.music.constants.ListenTogetherBlockedUsersKey, "")
    ...
    private suspend fun saveBlockedUsernames() {
        try {
            ...
            context.dataStore.edit { preferences ->
                preferences[com.audic.music.constants.ListenTogetherBlockedUsersKey] = blockedJson
            }
        } catch (e: Exception) {

...
import com.audic.music.constants.AutomixDebugOverlayKey
...
import com.audic.music.constants.EnableGoogleCastKey
...
import com.audic.music.constants.SeekExtraSeconds
import com.audic.music.constants.ShufflePlaylistFirstKey
import com.audic.music.constants.SimilarContent
import com.audic.music.constants.ShowAudioFallbackToastKey
...
highlightKey: String? = null) {
    ...
    val (downloadQuality, onDownloadQualityChange) = rememberEnumPreference(
        ...
        defaultValue = com.audic.music.constants.DownloadQuality.YOUTUBE
    )
    ...
    isHighlighted = (highlightKey == stringResource(R.string.seek_seconds_addup)),
                ...
                add(Material3SettingsItem(
    isHighlighted = (highlightKey == stringResource(R.string.audic_equalizer)),
                    icon = painterResource(R.drawable.audicequlizer),
                    title = { Text(stringResource(R.string.audic_equalizer)) },
                    description = { Text(stringResource(R.string.audic_equalizer_desc)) },
    ...
    isHighlighted = (highlightKey == stringResource(R.string.export_desc)),
                ...
                Material3SettingsItem(
                    ...
                    onClick = { navController.navigate("settings/audic_extractor") }
                )
            )
        )

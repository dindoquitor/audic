...
import com.audic.music.eq.data.FilterType
import com.audic.music.eq.data.ParametricEQBand
...
class AxionEqViewModel @Inject constructor(
    ...
    private val prefs = context.getSharedPreferences("audic_eq_prefs", Context.MODE_PRIVATE)
    ...
    val customProfiles = eqProfileRepository.profiles.map { profiles ->
        profiles.filter { it.isCustom && it.id != "audic_tuning" }

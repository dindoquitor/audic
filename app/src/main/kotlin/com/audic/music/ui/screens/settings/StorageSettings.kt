...
import com.audic.music.constants.MaxImageCacheSizeKey
...
import com.audic.music.ui.utils.formatFileSize
        ...
        ActionPromptDialog(
            ...
            onConfirm = {
                androidx.media3.exoplayer.offline.DownloadService.sendRemoveAllDownloads(
                    context,
                    com.audic.music.playback.ExoDownloadService::class.java,
                    false
                )

...
object IconUtils {
    fun setIcon(context: Context, isDynamic: Boolean, isLegacy: Boolean) {
        ...
        val dynamic = ComponentName(context, "com.audic.music.MainActivityAlias")
        val static = ComponentName(context, "com.audic.music.MainActivityStatic")
        val legacy = ComponentName(context, "com.audic.music.MainActivityLegacy")

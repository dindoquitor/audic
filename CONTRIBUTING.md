# Contributing to Audic Music

Thank you for your interest in contributing to Audic Music! This document provides comprehensive guidelines and information for contributors.
...
2. Add Android apps with package names:
   - `com.audic.music` (release)
   - `com.audic.music.debug` (debug)
...
When contributing to Audic Music, it's crucial to handle sensitive information properly:
...
./gradlew test --tests "com.audic.musicPlayerTest"
...
Thank you for contributing to Audic Music!

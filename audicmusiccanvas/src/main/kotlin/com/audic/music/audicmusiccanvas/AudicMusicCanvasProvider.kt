package com.audic.music.audicmusiccanvas
...
@Serializable
data class audicmusicCanvasManifest(
    val items: List<audicmusicCanvasItem> = emptyList()
)

@Serializable
data class audicmusicCanvasItem(
    val song: String,
    val artist: String,
    val url: String
)

object audicmusicCanvasProvider {
    ...
    private data class CacheEntry(
        val value: audicmusicCanvasManifest?,
    ...
    private suspend fun fetchManifest(): audicmusicCanvasManifest? {
        ...
        return try {
            val manifest: audicmusicCanvasManifest = client.get(BASE_URL).body()
